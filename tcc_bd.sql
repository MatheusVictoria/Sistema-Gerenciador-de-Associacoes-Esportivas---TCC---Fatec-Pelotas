...
CREATE TABLE IF NOT EXISTS `tcc_bd`.`turma` (
  ...
  INDEX `fk_turma_aluno1_idx` (`aluno_id` ASC),
  ...
  CONSTRAINT `fk_turma_aluno1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_turma_centro_treinamento1`
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`aluno_has_modalidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`aluno_has_modalidade` (
  `aluno_id` INT NOT NULL,
  `modalidade_id` INT NOT NULL,
  PRIMARY KEY (`aluno_id`, `modalidade_id`),
  INDEX `fk_aluno_has_modalidade_modalidade1_idx` (`modalidade_id` ASC),
  INDEX `fk_aluno_has_modalidade_aluno1_idx` (`aluno_id` ASC),

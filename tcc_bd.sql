...
-- -----------------------------------------------------
-- Table `tcc_bd`.`graduacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`graduacao` (
...
-- Table `tcc_bd`.`pais`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`pais` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `tcc_bd`.`estado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`estado` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
...
-- Table `tcc_bd`.`cidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`cidade` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`endereco` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `cidade_idx` (`cidade_id` ASC),
  CONSTRAINT `endereco_cidade`
    FOREIGN KEY (`cidade_id`)
    REFERENCES `tcc_bd`.`cidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `tcc_bd`.`aluno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`aluno` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `rg` INT(10) NOT NULL,
  `cpf` INT(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `grau_idx` (`graduacao_id` ASC),
  INDEX `endereco_idx` (`endereco_id` ASC),
  CONSTRAINT `aluno_graduacao`
    FOREIGN KEY (`graduacao_id`)
    REFERENCES `tcc_bd`.`graduacao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `aluno_endereco`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `tcc_bd`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`centro_treinamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`centro_treinamento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `endereco_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `endereco_idx` (`endereco_id` ASC),
  CONSTRAINT `endereco_centro_treinamento`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `tcc_bd`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `tcc_bd`.`professor` (
  ...
  `cpf` INT(11) NULL,
  INDEX `endereco_idx` (`endereco_id` ASC),
  INDEX `graduacao_idx` (`graduacao_id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `professor_endereco`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `tcc_bd`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `professor_graduacao`
    FOREIGN KEY (`graduacao_id`)
    REFERENCES `tcc_bd`.`graduacao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`modalidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`modalidade` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tcc_bd`.`turma` (
  ...
  `centro_treinamento_id` INT NOT NULL,
  `modalidade_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_turma_professor1_idx` (`professor_id` ASC),
  INDEX `fk_turma_centro_treinamento1_idx` (`centro_treinamento_id` ASC),
  INDEX `fk_turma_modalidade_idx` (`modalidade_id` ASC),
  CONSTRAINT `fk_turma_professor`
    FOREIGN KEY (`professor_id`)
    REFERENCES `tcc_bd`.`professor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_turma_centro_treinamento`
    FOREIGN KEY (`centro_treinamento_id`)
    REFERENCES `tcc_bd`.`centro_treinamento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_turma_modalidade`
    FOREIGN KEY (`modalidade_id`)
    REFERENCES `tcc_bd`.`modalidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`turma_has_aluno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`turma_has_aluno` (
  ...
  CONSTRAINT `fk_turma_has_aluno_turma1`
    ...
    REFERENCES `tcc_bd`.`turma` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_turma_has_aluno_aluno1`
    FOREIGN KEY (`aluno_id`)
    REFERENCES `tcc_bd`.`aluno` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`mensalidade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`mensalidade` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `valor` DECIMAL(9,2) NOT NULL,
  `data_vencimento` DATE NOT NULL,
  `valor_pago` DECIMAL(9,2) NOT NULL,
  `data_pagamento` DATE NOT NULL,
  `turma_has_aluno_turma_id` INT NOT NULL,
  `turma_has_aluno_aluno_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_mensalidade_turma_has_aluno1_idx` (`turma_has_aluno_turma_id` ASC, `turma_has_aluno_aluno_id` ASC),
  CONSTRAINT `fk_mensalidade_turma_has_aluno1`
    FOREIGN KEY (`turma_has_aluno_turma_id` , `turma_has_aluno_aluno_id`)
    REFERENCES `tcc_bd`.`turma_has_aluno` (`turma_id` , `aluno_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`presenca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`presenca` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `data` DATE NULL,
  `aluno_id` INT NULL,
  `turma_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `aluno_idx` (`aluno_id` ASC),
  INDEX `presenca_turma_idx` (`turma_id` ASC),
  CONSTRAINT `presenca_aluno`
    FOREIGN KEY (`aluno_id`)
    REFERENCES `tcc_bd`.`aluno` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `presenca_turma`
    FOREIGN KEY (`turma_id`)
    REFERENCES `tcc_bd`.`turma` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`historico_aluno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`historico_aluno` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `aluno_id` INT NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `aluno_idx` (`aluno_id` ASC),
  INDEX `modalidade_idx` (`modalidade_id` ASC),
  CONSTRAINT `historico_aluno_aluno`
    FOREIGN KEY (`aluno_id`)
    REFERENCES `tcc_bd`.`aluno` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `historico_aluno_modalidade`
    FOREIGN KEY (`modalidade_id`)
    REFERENCES `tcc_bd`.`modalidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `tcc_bd`.`tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`tipo` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tcc_bd`.`usuario` (
  ...
  `email` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `tipo_idx` (`tipo_id` ASC),
  CONSTRAINT `usuario_tipo`
    FOREIGN KEY (`tipo_id`)
    REFERENCES `tcc_bd`.`tipo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`patrocinador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`patrocinador` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `contato` VARCHAR(21) NULL,
...
-- Table `tcc_bd`.`evento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`evento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `data` DATE NOT NULL,
  ...
  `modalidade_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_evento_modalidade1_idx` (`modalidade_id` ASC),
  CONSTRAINT `fk_evento_modalidade1`
    FOREIGN KEY (`modalidade_id`)
    REFERENCES `tcc_bd`.`modalidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`contato`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`contato` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `email` VARCHAR(50) NOT NULL,
  `data` DATE NOT NULL,
...
-- Table `tcc_bd`.`log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`log` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `usuario_id` INT NOT NULL,
  `acao` TEXT(50) NOT NULL,
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`permissao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`permissao` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`tipo_has_permissao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`tipo_has_permissao` (
  `tipo_id` INT NOT NULL,
  `permissao_id` INT NOT NULL,
  PRIMARY KEY (`tipo_id`, `permissao_id`),
  INDEX `fk_tipo_has_permicao_permicao1_idx` (`permissao_id` ASC),
  INDEX `fk_tipo_has_permicao_tipo1_idx` (`tipo_id` ASC),
  CONSTRAINT `fk_tipo_has_permicao_tipo1`
    FOREIGN KEY (`tipo_id`)
    REFERENCES `tcc_bd`.`tipo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tipo_has_permicao_permicao1`
    FOREIGN KEY (`permissao_id`)
    REFERENCES `tcc_bd`.`permissao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`historico_aula`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`historico_aula` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `historico_aula_turma`
    FOREIGN KEY (`turma_id`)
    REFERENCES `tcc_bd`.`turma` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`tipo_lesao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`tipo_lesao` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`historico_aluno_has_tipo_lesao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`historico_aluno_has_tipo_lesao` (
  `historico_aluno_id` INT NOT NULL,
  `tipo_lesao_id` INT NOT NULL,
  PRIMARY KEY (`historico_aluno_id`, `tipo_lesao_id`),
  INDEX `fk_historico_aluno_has_tipo_lesao_tipo_lesao1_idx` (`tipo_lesao_id` ASC),
  INDEX `fk_historico_aluno_has_tipo_lesao_historico_aluno1_idx` (`historico_aluno_id` ASC),
  CONSTRAINT `fk_historico_aluno_has_tipo_lesao_historico_aluno1`
    FOREIGN KEY (`historico_aluno_id`)
    REFERENCES `tcc_bd`.`historico_aluno` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_historico_aluno_has_tipo_lesao_tipo_lesao1`
    FOREIGN KEY (`tipo_lesao_id`)
    REFERENCES `tcc_bd`.`tipo_lesao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`patologia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`patologia` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tcc_bd`.`aluno_has_patologia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tcc_bd`.`aluno_has_patologia` (
  `aluno_id` INT NOT NULL,
  `patologia_id` INT NOT NULL,
  PRIMARY KEY (`aluno_id`, `patologia_id`),
  INDEX `fk_aluno_has_patologia_patologia1_idx` (`patologia_id` ASC),
  INDEX `fk_aluno_has_patologia_aluno1_idx` (`aluno_id` ASC),
  CONSTRAINT `fk_aluno_has_patologia_aluno1`
    FOREIGN KEY (`aluno_id`)
    REFERENCES `tcc_bd`.`aluno` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aluno_has_patologia_patologia1`
    FOREIGN KEY (`patologia_id`)
    REFERENCES `tcc_bd`.`patologia` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
--  OS inserts a seguir populam as tabelas pais, estado e cidades.
-- -----------------------------------------------------
...
( 'Central do Maranhão', 1),

( 'Centro do Guilherme', 1),

( 'Centro Novo do Maranhão', 1),
...
( 'Itaipava do Grajaú', 1),

( 'Itapecuru Mirim', 1),

( 'Itinga do Maranhão', 1),
...
( 'Santa Luzia do Paruá', 1),

( 'Santa Quitéria do Maranhão', 1),

( 'Santa Rita', 1),

( 'Santana do Maranhão', 1),

( 'Santo Amaro do Maranhão', 1),

( 'Santo Antônio dos Lopes', 1),
...
( 'São Domingos do Azeitão', 1),

( 'São Domingos do Maranhão', 1),

( 'São Félix de Balsas', 1),

( 'São Francisco do Brejão', 1),

( 'São Francisco do Maranhão', 1),
...
( 'São Mateus do Maranhão', 1),

( 'São Pedro da Água Branca', 1),

( 'São Pedro dos Crentes', 1),

( 'São Raimundo das Mangabeiras', 1),

( 'São Raimundo do Doca Bezerra', 1),
...
-- -----------------------------------------------------
--  OS inserts a seguir populam a tabela tipo_lesao.
-- -----------------------------------------------------
INSERT INTO `tipo_lesao` (`lesao`) VALUES
('Fratura Braço Esquerdo'),
('Fratura Braço Direito'),
('Fratura Perna Esquerda'),
('Fratura Perna Direita'),
('Fratura Clavicula Direita'),
('Fraura Claviculo Esquerda'),
('Fratura Ombro Esquerdo'),
('Fratura no Ombro Direito'),
('Fratura Joelho Esquerdo'),
('Fratura Joelho Direito'),
('Fratura Tornoselo Esquerdo'),
('Fratura Tornoselo Direito'),
('Fratura Mão Esquerda'),
('Fratura Mão Direita'),
('Torção Joelho Direito'),
('Torção Joelho Esquerdo'),
('Torção Tornoselo Esquerdo'),
('Torção Tornoselo Direito'),
('Torção Cotovelo Direito'),
('Torção Cotovelo Esquerdo'),
('Torção Pulso Direito'),
('Torção Pulso Esquerdo'),
('Luxação Tornozelo Direito'),
('Luxação Tornozelo Esquerdo'),
('Luxação Joelho Direito'),
('Luxação Joelho Esquerdo'),
('Luxação Ombro Direito'),
('Luxação Ombro Esquerdo'),
('Luxação Cotovelo Direito'),
('Luxação Cotovelo Esquerdo'),
('Luxação Pulso Direito'),
('Luxação Pulso Esquerdo'),
('Contusão'),
('Distenção Muscular'),
('Outras')
...
-- -----------------------------------------------------
--  OS inserts a seguir populam as tabelas patologia.
-- -----------------------------------------------------
INSERT INTO `patologia` (`patologia`) VALUES ('Hipertensão'),
('Hipotensão'),
('Diabetes'),
('ReniteAlérgica'),
('Asma'),

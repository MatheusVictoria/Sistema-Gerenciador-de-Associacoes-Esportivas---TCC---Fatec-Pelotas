...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-dashboard"></i> Centro de treinamento </a></li>
        </ol>
    </section>
    <!-- right col -->
    <div>
            ...
            <div class="row">
                ...
                <div >
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" method="post" action="<?= base_url('Relatorios/gera_relatorio_pagamento_ct') ?>" enctype="multipart/form-data">
